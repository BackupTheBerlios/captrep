        ...
        Registry
{
    ...
    static
    {
        ...
        topLevelKeys.put ( "HKEY_CURRENT_CONFIG" ,
                           Registry.HKEY_PERFORMANCE_DATA ) ;
    ...
    public static void
            exportRegistryKey ( String pathName , RegistryKey key ,
                                boolean descend )
...
System.out.println ("top key " + topKeyName + ", keyName : " + keyName);
    ...
    private static RegistryKey
            openSubKeyVerbose ( RegistryKey topKey , String keyName ,
                                int access )
    {
        RegistryKey subKey = null ;
    ...
    public static void
            dumpHexData ( PrintStream out , String title , byte[] buf ,
                          int numBytes )
    {
        PrintWriter wrtr =
